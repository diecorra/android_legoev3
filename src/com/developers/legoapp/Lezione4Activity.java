...
public class Lezione4Activity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lezione4);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.button1:
			Intent intent = new Intent(this, GruActivity.class);
			startActivityForResult(intent, GET_VALUE);

			break;

		case R.id.button2:
			Intent intent1 = new Intent(this, GuidoActivity.class);
			startActivityForResult(intent1, GET_VALUE);

			break;

		case R.id.button6:
			Lezione4Activity.this.finish();
