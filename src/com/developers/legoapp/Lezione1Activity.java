...
public class Lezione1Activity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lezione1);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.button1:
			Intent intent = new Intent(this, GattoNeroActivity.class);
			startActivityForResult(intent, GET_VALUE);

			break;

		case R.id.button2:
			Intent intent1 = new Intent(this, AltalenaActivity.class);
			startActivityForResult(intent1, GET_VALUE);

			break;

		case R.id.button6:
			Lezione1Activity.this.finish();
