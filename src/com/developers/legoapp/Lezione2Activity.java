...
public class Lezione2Activity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lezione2);
	...
	public void onClick(View v) {
		...
		case R.id.button2:
			Intent intent1 = new Intent(this, RallyActivity.class);
			startActivityForResult(intent1, GET_VALUE);

			break;

		case R.id.button6:
			Lezione2Activity.this.finish();
